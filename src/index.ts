import { quad, back, circ, bounce, elastic, makeEaseOut, makeEaseInOut, animate, linear } from './functions/animation';

function hasClass({ element, className }: { element: Element; className: string }) {
